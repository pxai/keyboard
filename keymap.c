 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | CTRL | ALT  | [    |   ]  |change|                                | LEFT | DOWN |  UP  |RIGHT |  ¡¿   |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |  <   |  =   |       |   /  |  >   |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        // left hand
          ...
          KC_LCTL,KC_LALT, KC_LBRC, KC_RBRC, KC_FN1,
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_F4,KC_HASH,KC_DLR, KC_DOWN,KC_RPRN,KC_GRV,
       KC_LALT,KC_LGUI,KC_LCTL,KC_UP,KC_LEFT,KC_RIGHT,KC_LALT,
       KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_FN1,
                                       RGB_MOD,KC_TRNS,
                                               KC_TRNS,
       ...
       KC_TRNS, KC_UP,   KC_7,   KC_8,    KC_9,    KC_ASTR, KC_F12,
                KC_DOWN, KC_4,   KC_5,    KC_6,    KC_PLUS, KC_LBRC,
